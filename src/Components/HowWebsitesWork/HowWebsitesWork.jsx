  ...
  return (
    <div className="container mx-auto mt-10 space-y-4">
      ...
      <p>
        ...
        user must create a detailed profile to access the website's features.
        Users input their personal details, such as name, age, occupation,
        height, weight, race, family background, and more. Users upload photos
        and provide a bio to showcase their personality and preferences.
      </p>
      <p>
        <span className="font-extrabold ">Step 2: </span> Biodata Once a profile
        is created, users gain access to a database of biodata from other users
        on the platform. They can filter searches based on criteria .
      </p>
      <p>
